...
let slide1 = new Slide(
    "Google",
    "Google slide",
    "https://www.johnfdoherty.ie/wp-content/uploads/2016/12/6_logo_predesign.jpg",
    "http://google.com"
);
...
let slide2 = new Slide(
    "Yahoo",
    "Yahoo slide",
    "https://i2.wp.com/thinkmarketingmagazine.com/wp-content/uploads/2013/08/Yahoo-Current-Logo.jpg?resize=482%2C214&ssl=1",
    "http://yahoo.com"
);
...
function buildSlider(){
    ...
    for(let i = 0; i < slideArray.length; i++) {
        myHTML += "<div id='" + slideArray[i].id +
            ...
            "<a class='slider' href='" + slideArray[i].link + "' target ='_blank'>Open Link</a>" + "</div>" + "</div>";
